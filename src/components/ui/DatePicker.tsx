...
export function DatePicker({ defaultValue = "", placeholder = "", onChange, alignedRight = false, handleRelative = true, topClassName = "top-12" }: DatePickerProps) {
                    ...
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="rounded px-1 py-1 text-xs font-semibold hover:bg-background-tertiary"
                                type="button"
                            >
                                Today
                            </button>
                        ...
                        {calendarDays.map((day, i) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-1.5 text-sm rounded border hover:bg-background-tertiary ${isSelected && "bg-primary"} ${isToday ? "border-primary" : "border-transparent"}`}
                                    type="button"
                                >
                                    {day}
                                </button>
